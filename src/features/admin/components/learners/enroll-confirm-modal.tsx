...
export interface EnrollConfirmModalProps {
  isOpen: boolean;
  onConfirm: () => void;
  onCancel: () => void;
}

export const EnrollConfirmModal: React.FC<EnrollConfirmModalProps> = ({
  isOpen,
  onConfirm,
  onCancel,
}) => {
    ...
    >
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-xs text-neutral-secondary mb-6">
          Confirm you want to enroll learner for this course
        </p>
