...
export interface SuspendLearnerConfirmModalProps {
  isOpen: boolean;
  onConfirm: () => void;
  onCancel: () => void;
}

export const SuspendLearnerConfirmModal: React.FC<SuspendLearnerConfirmModalProps> = ({
  isOpen,
  onConfirm,
  onCancel,
}) => {
    ...
    >
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-xs text-neutral-secondary mb-6">
          Confirm you want to suspend this learner
        </p>
