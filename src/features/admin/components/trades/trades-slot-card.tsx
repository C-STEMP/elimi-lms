...
export const TradesSlotCard: React.FC<TradesSlotCardProps> = ({
  ...
  if (slot.status === "empty" || !slot.tradeId) {
    return (
      <div className="border-2 border-dashed border-gray-200/90 hover:border-primary-solid/40 bg-white hover:bg-[#fafafc] rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between items-center text-center group min-h-55">
        ...
        <div className="flex flex-col items-center py-2">
          <div className="w-12 h-12 rounded-2xl bg-primary-solid/5 group-hover:bg-primary-solid text-primary-solid group-hover:text-white transition-all flex items-center justify-center mb-3 shadow-2xs">
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-2xs hover:shadow-md hover:border-gray-200/80 transition-all duration-300 p-6 flex flex-col justify-between group relative overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-primary-solid to-secondary opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

      <div>
        <div className="flex items-center justify-between gap-2 mb-3.5">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary-solid/10 text-primary-solid border border-primary-solid/20 font-bold text-xs tracking-wider">
        ...
        <div className="flex flex-wrap items-center gap-2 mt-4">
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-secondary/10 border border-secondary/30 text-xs font-semibold text-[#a86500]">
