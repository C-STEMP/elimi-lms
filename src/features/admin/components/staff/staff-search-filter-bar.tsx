...
import type { StaffViewMode } from "../../types/staff";

export interface StaffSearchFilterBarProps {
  searchQuery: string;
...
export const StaffSearchFilterBar: React.FC<StaffSearchFilterBarProps> = ({
  searchQuery,
  onSearchChange,
  viewMode,
  onViewModeChange,
