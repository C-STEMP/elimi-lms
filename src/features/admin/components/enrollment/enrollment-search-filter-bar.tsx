...
import type { EnrollmentViewMode } from "../../types/enrollment";

export interface EnrollmentSearchFilterBarProps {
  searchQuery: string;
  onSearchChange: (query: string) => void;
  viewMode: EnrollmentViewMode;
  onViewModeChange: (mode: EnrollmentViewMode) => void;
  onFilterClick?: () => void;
}

export const EnrollmentSearchFilterBar: React.FC<EnrollmentSearchFilterBarProps> = ({
  searchQuery,
  onSearchChange,
  viewMode,
  onViewModeChange,
